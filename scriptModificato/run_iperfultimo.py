...
# Il config file ha SEMPRE un valore (default relativo allo script bash)
...
# Il config file è SEMPRE il primo argomento al bash, in modo che
# $1=CONFIG_FILE  $2=LOG_FILE  $3=IPERF_EXTRA_ARGS
...
for idx, extra_args in enumerate(EXTRA_ARGS_LIST, start=1):
    ...
    # bash riceve: $1=CONFIG_FILE  $2=LOG_FILE  $3=IPERF_EXTRA_ARGS
    cmd = base_cmd.copy()
